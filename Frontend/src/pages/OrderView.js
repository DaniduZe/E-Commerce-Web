        ...
        <div className="bg-white shadow-lg rounded-lg p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <p className="text-gray-600"><strong>Total Amount:</strong> Rs.{orderDetails.totalAmount}</p>
            </div>
          ...
          <div className="space-y-4">
            {orderDetails.items.map((item) => (
              <div key={item.productId} className="border p-4 rounded-lg shadow-sm bg-gray-50">
                ...
                <p className="text-gray-700"><strong>Total Item Price:</strong> Rs.{item.totalItemPrice}</p>
              </div>
            ))}
          </div>
        </div>
